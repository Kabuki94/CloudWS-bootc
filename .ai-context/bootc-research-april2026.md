...
> **Status:** Bootstrapped 2026-05-11 by `scheduled-research-daily`. Live document — refined daily. Latest pass 2026-05-22.
...
## Top-priority action items (current — 2026-05-22)
...
| - | ----------- | ------------ |
| 1 | bootc + bootc-image-builder + image-builder-cli | 2026-05-22 |
| 2 | ucore-hci / Universal Blue base | 2026-05-22 |
| 3 | Fedora bootc / FCOS / composefs / OSTree | 2026-05-19 |
| 4 | Podman + Quadlet + rechunk | 2026-05-19 |
| 5 | K3s + Ceph + Pacemaker/Corosync | 2026-05-22 |
| 6 | CrowdSec + fapolicyd + usbguard + SELinux + kernel CVEs | 2026-05-22 |
| 7 | cosign/Sigstore + Secure Boot/MOK | 2026-05-22 |
| 8 | NVIDIA kmods + Container Toolkit / CDI | 2026-05-22 |
| 9 | VFIO/IOMMU + Looking Glass + KVMFR + QEMU + libvirt | 2026-05-22 |
| 10 | Gamescope + Waydroid + Mesa/ROCm | 2026-05-22 |
| 11 | FreeIPA/SSSD + GNOME + WSL2 | 2026-05-22 |
| 12 | kargs.d + Renovate + systemd-sysext + tmpfiles + bootc lifecycle | 2026-05-22 |
...
- **CVE-2026-31635 — "DirtyDecrypt"** *(added 2026-05-22).* RxGK (AFS rxrpc auth) LPE. **CVSS 7.5. Only triggers on `CONFIG_RXGK` kernels (Fedora / Arch / openSUSE Tumbleweed) → applies to the MiOS Fedora base.** Fix is upstream (commit `aa54b1d27fe0`; date sources conflict — an earlier note cited 2026-04-25 merge, kernel-git shows commit ~2026-05-10 — date unconfirmed but immaterial since the base is pre-fix regardless). **Public PoC released 2026-05-18.** Present in kernel.org stable trees 7.0.9 / 6.18.32 / 6.12.90 (2026-05-17). Container/pod-escape pathway noted. **COULDN'T VERIFY exact Fedora kernel NVR** (Fedora bodhi Anubis-gated). Defense-in-depth if unused: RxGK is an AFS/rxrpc auth surface MiOS almost certainly doesn't use — blacklisting `rxrpc` removes it, but `CONFIG_RXGK` is base-kernel config the project doesn't own. Source: https://thehackernews.com/2026/05/dirtydecrypt-poc-released-for-linux.html.
...
- **Renovate:** **v43.192.0** (2026-05-22). Routine cadence — no security advisories surfaced. Bootstrap baseline (43.173.0) is now ~19 minor versions behind, but config compatibility unchanged.
