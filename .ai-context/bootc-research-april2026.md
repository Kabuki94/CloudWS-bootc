...
> **Status:** Bootstrapped 2026-05-11 by `scheduled-research-daily`. Live document — refined daily. Latest pass 2026-05-27.
...
## Top-priority action items (current — 2026-05-27)
...
| 2 | ucore-hci / Universal Blue base | 2026-05-27 |
...
| 6 | CrowdSec + fapolicyd + usbguard + SELinux + kernel CVEs | 2026-05-27 |
| 7 | cosign/Sigstore + Secure Boot/MOK | 2026-05-27 |
| 8 | NVIDIA kmods + Container Toolkit / CDI | 2026-05-27 |
| 9 | VFIO/IOMMU + Looking Glass + KVMFR + QEMU + libvirt | 2026-05-26 |
| 10 | Gamescope + Waydroid + Mesa/ROCm | 2026-05-26 |
| 11 | FreeIPA/SSSD + GNOME + WSL2 | 2026-05-27 |
| 12 | kargs.d + Renovate + systemd-sysext + tmpfiles + bootc lifecycle | 2026-05-27 |
...
### 7.1 cosign / Sigstore
*Recorded 2026-05-11.* *(updated 2026-05-19: `GHSA-w6c6-c85g-mmv6` now has CVE assignment **CVE-2026-39395** (CVSS 4.3 Moderate, `verify-blob-attestation` false positive); already fixed in v3.0.6, no remediation change. No new releases; v3.0.6 still latest.)* *(updated 2026-05-22: re-verified — **still v3.0.6 (2026-04-06)**, no newer release, no new GHSAs/CVEs.)* *(updated 2026-05-27: re-verified — **still v3.0.6 (2026-04-06)**; newest security advisory still `GHSA-w6c6-c85g-mmv6` (2026-04-06); no advisory after April 2026. Pin floor ≥3.0.6 remains adequate.)*
...
- **Feature Branches (DISTINCT):**
  ...
  - **New-Feature-Branch: 610.43.02** (2026-05-26 — added 2026-05-27). Supersedes the 595.44.x dev-beta line as the bleeding-edge feature branch. Adds Vulkan multi-GPU logical devices (`VK_KHR_device_group_creation`), FP16 EGL on Wayland, DRM multiplanar YCbCr format modifiers, mmap on dGPU DMABUF fds, and a per-plane DRM color-pipeline API targeting Linux 6.19. **Not LTS, not production-feature, not a project pin** — informational. Commit `57130a27`. Source: https://github.com/NVIDIA/open-gpu-kernel-modules/releases/tag/610.43.02.
- **No 600-series production/LTS driver shipped** as of 2026-05-27 (610.43.02 is a *new-feature* branch only). Kernel 6.18 ships no Blackwell-specific FLR/IOMMU 1:1 patches.
...
- **FreeIPA:** **4.13.1** (git tag `release-4-13-1`, 2026-01-16 — *corrected 2026-05-27: was recorded as 4.13.0 since bootstrap; 4.13.1 is the actual latest tag. FreeIPA publishes via git tags, not GitHub Releases.*). 4.13.0 (2025-12-04) had >170 fixes since 4.12.5; beta of new responsive WebUI. No new 2026 CVE.
...
- **Renovate:** **v43.196.1** (2026-05-27 — updated 2026-05-27, was 43.195.8; routine patch/minor cadence — a maven-range fix in 43.196.x and a simple-git security-dep bump noted at 43.195.12). No Renovate-product security advisory. Bootstrap baseline (43.173.0) is now ~23 minor versions behind, but config compatibility unchanged.
...
- **systemd 260 stable shipped 2026-03-17** (drops SysV, adds mstack, Varlink metrics). systemd 259.5 latest in 259 series. systemd 258 (Sep 2025) introduced major sysext improvements. *(updated 2026-05-24: **v261-rc1 cut 2026-05-22** — pre-release/unstable (Live Update Orchestration + new Varlink interfaces); stable track unchanged at v260.1 (2026-03-23), no action for the project's stable base.)* *(updated 2026-05-27: **stable 260.x advanced to v260.2 (2026-05-27)** — routine patch on the project's stable base; no security content flagged by upstream (check NEWS if pinning exactly). Unstable advanced to **v261-rc2 (2026-05-26)** (rc1 now dated 2026-05-24). No action for the stable base beyond noting v260.2.)*
...
- 2026-05-27 — daily pass: **HEADLINE — the rolling `:stable-nvidia` tag the project actually pins IS being re-baked daily** (resolves the standing P2 open question). Registry probe: rolling `ucore-hci:stable-nvidia` rebaked **2026-05-27T04:13:01Z** (index `sha256:bf999c72…`, amd64 `sha256:1f44a959…`) on revision `e63e21f` = ucore #397 (post-#392 base) — same source/run as the dated LTS tag, which advanced to `-20260527`. **The kernel-CVE fix is now DELIVERABLE on the very tag MiOS pins** via a Renovate digest bump; remaining gate is purely project-side. Issue #385 still open. Items 1/8, §2, §6.5 updated. Other changes: **NVIDIA new-feature branch 610.43.02 (2026-05-26)** — NOT LTS/production/beta, informational only, not a project pin; no June bulletin; §8.1 + item 3 updated. **systemd stable v260.2 (2026-05-27)** + unstable v261-rc2 (2026-05-26); §12.3. **Renovate v43.196.1 (2026-05-27)**; §12.2. **WSL pre-release 2.8.7 (2026-05-26)** (stable still 2.7.7); §11.3. **FreeIPA baseline correction → 4.13.1 (tag `release-4-13-1`, 2026-01-16)** — was wrongly recorded as 4.13.0 since bootstrap; §11.1. **Secure Boot shim-16.1-6 STILL absent** from all F44 trees (re-verified; ~29 days to 2026-06-26 cutover, ~9 days to the 2026-06-05 checkpoint — tightest unresolved risk, unchanged four passes running); item 4 + §7.2. **QEMUtiny still has NO published CVE-ID** (only the oss-sec 2026-05-20 advisory; QEMU still 11.0.1, no blog post); §9.4. **GNOME 50.2 STILL not shipped** (verified via download.gnome.org `sources/mutter/50/` + `gnome-remote-desktop/50/` — only 50.0/50.1; tarball deadline 4 days overdue); §11.2. NO CHANGE: cosign 3.0.6 (no new GHSA), kernel cluster + kernel.org (mainline 7.1-rc5; stable 7.0.10; longterm 6.18.33/6.12.91/6.6.141/6.1.174) + RHSB-2026-003 (Ongoing/Important), CVE-2026-31431 (7.8/KEV), bootc 1.15.2, OSTree 2026.1, composefs 1.0.8 (no v1.1; main at a7ea6cd 2026-05-19; bootc native backend still verbatim "Experimental"), image-builder-cli v66 (#506 still open; BIB no deprecation; osbuild.org/blog still 404), Podman 5.8.2 (no 6.0 RC; Quadlet schema-delta docs still placeholder), K3s GA tags (05-20), etcd 3.7.0-beta.0, Ceph 20.2.1, CrowdSec 1.7.8, fapolicyd 1.5, NVIDIA LTS 580.159.04 / production-feature 595.71.05, NVIDIA Container Toolkit 1.19.1, Pacemaker 3.0.2-rc2 (no rc3/final — a web-search "final 2026-04-23" claim was a hallucination, disregarded), Corosync 3.1.10, libvirt 12.3.0 (12.4.0 still unreleased), Mesa 26.1.1/26.0.7, ROCm 7.2.3, Waydroid 1.6.2, SSSD 2.13.0, Looking Glass B7 (master + `module/` idle ~4 months), Gamescope 3.16.24 (#2018 still open, HDR fix 7d4e835 still master-only), RTX 50-series passthrough still broken (RTX 4090 unaffected), F45 Beta 2026-08-25.
